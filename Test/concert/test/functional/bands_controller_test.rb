...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { band_id: @band.band_id, member: @band.member, name: @band.name, style: @band.style }
    end
  ...
  test "should update band" do
    put :update, id: @band, band: { band_id: @band.band_id, member: @band.member, name: @band.name, style: @band.style }
    assert_redirected_to band_path(assigns(:band))
  end
